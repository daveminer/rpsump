...
impl Debouncer {
    pub fn new(level: Level, duration: Duration) -> Self {
        Self {
...
mod tests {
    ...
    async fn test_reset_deadline() {
        let mut debouncer = Debouncer::new(Level::High, Duration::from_secs(1));
    ...
    #[tokio::test]
    async fn test_sleep() {
        let debouncer = Debouncer::new(Level::High, Duration::from_secs(1));
